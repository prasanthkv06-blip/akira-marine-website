...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription: 'Rapid mobilisation of technicians to resolve unexpected engine issues and minimise downtime.',
    fullDescription: 'When an unexpected engine issue arises, we mobilise technicians quickly to diagnose the fault, restore operation, and minimise costly downtime — with clear escalation, documentation, and root-cause reporting throughout.',
    icon: 'siren',
